...
CCTV_SLIDER = ("None","Crime spots only", "Town centres", "Widespread", "Every street corner", "Facial recognition")
...
DEATH_SLIDER = ("None", "Mass murderers", "Homicide", "Homicide & rape", "Violent crimes", "Serious crimes", "Most crimes")
DETENTION_SLIDER = ("None", "72 hours", "7 days", "30 days", "90 days", "Unlimited")
GAMBLING_SLIDER = ("None", "Age & stakes limited", "Age limit", "No restrictions")
HANDGUN_SLIDER = ("No limit", "No machineguns", "No automatics", "Licence required", "Licence & min age", "Strict controls", "Total ban")
ID_SLIDER = ("None", "Voluntary", "Widespread", "Compulsory", "Biometric", "Heavily enforced")
INTEL_SLIDER = ("A few spies", "Small spy agency", "Sizeable agency", "High tech agency", "Spy satellite network")
...
RECYCLING_SLIDER = ("None","Poster campaign", "Bottle Banks", "Recycling centers", "Limited collection", "Universal collection")
ROAD_SLIDER = ("Essential maint.", "Basic maint.", "Existing fixed", "Some expansion", "Major expansion", "New road networks")
...
ABORTION_SLIDER = ("Total ban", "Life threatened", "Limited circum.", "2 doctors apporve", "On demand")
...
gated_sb = Spinbox(policies_fr, values=GATED_SLIDER, bg=ENTRY_COLOUR, font=BODY, relief=FLAT, width=SB_WIDTH, state="readonly")
...
# Save button
Button(buttons_fr, text="Save", width = 15, bg=BG_COLOUR, font=BUTTON).grid(row=0, column=0, padx=5, pady=10, sticky=E)

# Load button
Button(buttons_fr, text="Load", width = 15, bg=BG_COLOUR, font=BUTTON).grid(row=0, column=1, padx=5, pady=10, sticky=E)

# Export button
Button(buttons_fr, text="Export", width = 15, bg=BG_COLOUR, font=BUTTON).grid(row=0, column=2, padx=5, pady=10, sticky=E)
